...
// Function to get background image based on board number (resetCount)
const getBackgroundImage = (boardNumber) => {
  const backgrounds = [
    require('../../assets/background1.png'), // Board 1
    require('../../assets/background2.png'), // Board 2
    require('../../assets/background3.jpg'), // Board 3
    require('../../assets/background4.png'), // Board 4
    require('../../assets/background5.png'), // Board 5
  ];
  ...
  return (
    <View
      style={{
        ...
        padding: dimensions.containerPadding / 2,
        margin: 10,
        alignItems: "center",
      }}
    ...
    >
      ...
      <Text style={{ 
        ...
        3-4 letters: {getPointsForWord("abc", resetCount)}pts • 5 letters:{" "}
        {getPointsForWord("abcde", resetCount)}pts • 6+ letters:{" "}
      {getPointsForWord("abcdef", resetCount)}pts
    </Text>
    <Text style={{ 
      fontSize: dimensions.bodyFontSize - 2, 
      color: "#FF6B35", 
...
const PlaceholderWordDisplay = ({ previewWord }) => {
  ...
  const isBonus =
    previewWord.length >= 3 && isBonusWord(previewWord.toLowerCase());
...
function GameScreen() {
  ...
  // Calculate grid size based on screen size and device type
  const dimensions = getResponsiveDimensions();
  ...
  // Get current background image based on board number
  const currentBackgroundImage = getBackgroundImage(resetCount);
      ...
      >
        ...
        >
          <View style={{ flex: 1, justifyContent: "center", padding: 20 }}>
            <Card style={{ padding: 20, backgroundColor: 'rgba(255,255,255,0.95)' }} data-testid="game-over-card">
        ...
        >
          ...
          >
            ...
            >
              ...
              {/* Found Words Display - Basic version for now */}
              {foundWords.length > 0 && (
                <View
                  style={{
                    backgroundColor: "rgba(255,255,255,0.9)",
