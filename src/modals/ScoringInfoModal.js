              ...
              <Card.Content>
                ...
                <View style={styles.tipsList}>
                  <Paragraph style={styles.tip}>
                    • <Text style={styles.tipBold}>Longer words = More points</Text> - 8+ letter words give the highest scores
                  </Paragraph>
                  <Paragraph style={styles.tip}>
                    • <Text style={styles.tipBold}>Earlier boards = Higher multipliers</Text> - Board 1 gives maximum points
                  </Paragraph>
                  <Paragraph style={styles.tip}>
                    • <Text style={styles.tipBold}>Strategic play</Text> - Find long words early, or clear short words to progress
                  </Paragraph>
                  <Paragraph style={styles.tip}>
                    • <Text style={styles.tipBold}>Bonus words</Text> - Special words still give 300 points regardless of board
                  </Paragraph>
                </View>
              </Card.Content>
            </Card>
